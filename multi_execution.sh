...
for b in 0 0.002 0.004 0.006 0.008 0.01 0.012 0.014 0.016 0.018 0.02; do
    python grammar_evol.py --lang "$lang" --n_individuals "$n_individuals" --max_iter "$max_iter" --init_rules "$init_rules" --init_symbols "$init_symbols" --p_mutation "$p_mutation" --bloat "$b" --elite "0" --n_nonterminal "$n_nonterminal"
done
